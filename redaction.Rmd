...
Les deux pays, en dehors de la France, où se trouvent les emplois proposés sont : le Luxembourg et la Suisse.
...
**Avertissement** : dans certains cas, le département n'était pas indiquée mais à pu être déduite (par localisation d'une entreprise ou d'une entité administrative). Cependant, il peut exister des biais ou des erreurs, le poste proposé n'étant pas nécessairement localisé au siège de la société ou de l'administration.
